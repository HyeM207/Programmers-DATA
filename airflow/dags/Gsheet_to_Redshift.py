...
"""
실습 : 구글 스프레드 시트에서 데이터를 Airflow 로컬 서버로 가져오고 이를 s3에 적재 후 Redshift에 업로드하는 실습
"""
...
sheets = [
    {
        "url": "https://docs.google.com/spreadsheets/d/1vHY6jyM6_M9OruvB2LmW1DTqPdjdWIOZLmr5SiUyZL0/edit#gid=0",
        "tab": "SheetToRedshift",
        "schema": "hmk9667",
